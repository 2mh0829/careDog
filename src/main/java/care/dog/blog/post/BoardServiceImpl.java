...
public class BoardServiceImpl implements BoardService {
	...
	public int insertBoard(Board dto, String pathname) {
		...
		try {
			...
			int maxNum=dao.selectOne("blogBoard.maxNum", map);
			dto.setNum(maxNum+1);
	...
	public int dataCount(Map<String, Object> map) {
		...
		try {
			result=dao.selectOne("blogBoard.dataCount", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
	...
	public List<Board> listBoard(Map<String, Object> map) {
		...
		try {
			list=dao.selectList("blogBoard.listBoard", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
	...
	public Board readBoard(Map<String, Object> map) {
		...
		try {
			dto=dao.selectOne("blogBoard.readBoard", map);
		} catch (Exception e) {
		}
	...
	public Board preReadBoard(Map<String, Object> map) {
		...
		try {
			dto=dao.selectOne("blogBoard.preReadBoard", map);
		} catch (Exception e) {
		}
	...
	public Board nextReadBoard(Map<String, Object> map) {
		...
		try {
			dto=dao.selectOne("blogBoard.nextReadBoard", map);
		} catch (Exception e) {
		}
	...
	public int insertFile(Board dto, Map<String, Object> map) {
		int result=0;
		try {
			int maxNum=dao.selectOne("blogBoard.maxFileNum", map);
	...
	public List<Board> listFile(Map<String, Object> map) {
		...
		try {
			listFile=dao.selectList("blogBoard.listFile", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
	...
	public Board readFile(Map<String, Object> map) {
		...
		try {
			dto=dao.selectOne("blogBoard.readFile", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
	...
	public int insertReply(Reply dto) {
		...
		try {
			Map<String, Object> map=new HashMap<String, Object>();
			map.put("tableName", dto.getTableName());
			int maxNum=dao.selectOne("blogBoard.maxReplyNum", map);
	...
	public List<Reply> listReply(Map<String, Object> map) {
		...
		try {
			list=dao.selectList("blogBoard.listReply", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return list;
	...
	public List<Reply> listReplyAnswer(Map<String, Object> map) {
		List<Reply> list=null;
		try {
			list=dao.selectList("blogBoard.listReplyAnswer", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return list;
	...
	public int replyCountAnswer(Map<String, Object> map) {
		int result=0;
		try {
			result=dao.selectOne("blogBoard.replyCountAnswer", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return result;
	...
	public int replyDataCount(Map<String, Object> map) {
		int result=0;
		try {
			result=dao.selectOne("blogBoard.replyDataCount", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return result;
	...
	public Map<String, Object> replyCountLike(Map<String, Object> map) {
		...
		try {
			result=dao.selectOne("blogBoard.replyCountLike", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return result;
