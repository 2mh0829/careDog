...
public class CategoryServiceImpl implements CategoryService {
	...
	public int maxCategoryNum(Map<String, Object> map) {
		int result=0;
		try {
			result=dao.selectOne("boardCategory.maxCategoryNum", map);
		} catch (Exception e) {
	...
	public List<Category> listCategoryGroup(Map<String, Object> map) {
		...
		try {
			list=dao.selectList("boardCategory.listCategoryGroup", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return list;
	...
	public List<Category> listCategory(Map<String, Object> map) {
		List<Category> list=null;
		try {
			list=dao.selectList("boardCategory.listCategory", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return list;
	...
	public List<Category> listCategoryAll(Map<String, Object> map) {
		List<Category> list=null;
		try {
			list=dao.selectList("boardCategory.listCategoryAll", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return list;
	...
	public Category readCategory(Map<String, Object> map) {
		Category dto=null;
		try {
			dto=dao.selectOne("boardCategory.readCategory", map);
		} catch (Exception e) {
			System.out.println(e.toString());
		}
		return dto;
