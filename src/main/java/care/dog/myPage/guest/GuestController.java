...
public class GuestController {
	...
	@RequestMapping(value="/myPage/{myPageId}/guest")
	public String guest(
			@PathVariable int myPageId,
			Model model) throws Exception {

		model.addAttribute("myPageId",myPageId);
		return "myPage/guest/guest";
	}
	
	@RequestMapping(value="/myPage/{myPageId}/guestList")
	@ResponseBody
	...
	@RequestMapping(value="/myPage/{myPageId}/guestCreated", method=RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> createdSubmit(
		...
		return list(myPageId, 1, session);
	}
	
	@RequestMapping(value="/myPage/{myPageId}/guestDelete",
