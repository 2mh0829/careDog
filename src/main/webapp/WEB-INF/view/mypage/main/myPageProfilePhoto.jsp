<<<<<<< HEAD:src/main/webapp/WEB-INF/view/myPage/main/myPageProfilePhoto.jsp
...
<div class="profile-photo">
	<c:if test="${empty  myPageInfo.profilePhoto}">
		<img src="<%=cp%>/resource/images/noimage.png" width="250"
			height="250">
	</c:if>
	...
	<c:if test="${myPageInfo.memberId==sessionScope.member.memberId}">
		<div style="margin-top: 10px; padding: 5px 2px; text-align: center;">
			[<a href="javascript:editBlogProfileInfo();"><b>프로필 수정</b></a>
			<c:if test="${myPageInfo.memberId==sessionScope.member.memberId}">
...
>>>>>>> e3627eb54de605c15cde7d5898983e2424b3b4a0:src/main/webapp/WEB-INF/view/mypage/main/myPageProfilePhoto.jsp
