<<<<<<< HEAD:src/main/webapp/WEB-INF/view/mypage/manage/myPageCreated.jsp
...
<div class="bodyFrame3" style="margin-left:120px;">
...
<%-- 
      ...
      <%--      <tr height="40">
           ...
           <tr height="40" >
               ...
               <td colspan="2"> 
                      <input type="file" name="upload" class="boxTF"  size="61"  style="width:98%; ">                    
                </td>
           </tr> 
         ...
         <%--   <tr> 
           ...
           <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
              <tr height="45"> 
               <td align="center" >
                  <button type="button" class="btn1" onclick="sendMyPage();"> ${mode=="created"?"등록완료":"수정완료"} </button>
                       <button type="button" class="btn1" onclick="javascript:history.back();"> ${mode=="created"?"등록취소":"수정취소"} </button>
                       <c:if test="${mode=='update'}">
                           <input type="hidden" name="myPageId" value="${dto.myPageId}">
...
>>>>>>> ab1937f7fd6b38523c7b90a85ded71fb2ef00dec:src/main/webapp/WEB-INF/view/myPage/manage/myPageCreated.jsp
</div>