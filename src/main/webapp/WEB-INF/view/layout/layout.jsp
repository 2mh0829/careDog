...
<%-- <link rel="stylesheet" href="<%=cp %>/resource/bootstrap/css/bootstrap.min.css?ver=1" type="text/css"> --%>
...
<link rel="stylesheet" href="<%=cp %>/resource/css/layout.css?ver=2.2" type="text/css">
