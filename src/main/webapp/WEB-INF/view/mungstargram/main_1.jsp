...
<div class="body-container">
	...
	<div class="responsive">
		<div class="gallery">
			<a href="#" id="myBtn">
				<img src="<%=cp%>/resource/img/dog1.jpg" alt="Trolltunga Norway" >
			</a>
		</div>
	</div>
	...
	<div class="responsive">
		<div class="gallery">
			<a href="#"> <img src="<%=cp%>/resource/img/dog2.jpg" alt="Forest">
			</a>
		</div>
	</div>
	...
	<div class="responsive">
		<div class="gallery">
			<a href="#"> <img src="<%=cp%>/resource/img/test.jpg" alt="Northern Lights">
			</a>
		</div>
	</div>
	...
	<div class="responsive">
		<div class="gallery">
			<a href="#"> <img src="<%=cp%>/resource/img/dog4.jpg" alt="Mountains">
			</a>
		</div>
	</div>
