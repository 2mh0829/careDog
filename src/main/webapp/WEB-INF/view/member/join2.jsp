	        ...
	        <div> 
	        	<form name="memberForm" method="post">
				  ...
				  <tr>
				      ...
				      <td style="padding: 0 0 15px 15px;">
				        <p style="margin-top: 1px; margin-bottom: 5px;">
				            <input type="text" id="zipCode" name="zipCode" value="${dto.zip}"
				                       class="boxTF" readonly="readonly">
				            <button type="button" class="btn" onclick="searchZipCode();">우편번호</button>          
				        </p>
				      </td>
				  </tr>
				  ...
				  <tr>
				      ...
				      <td style="padding: 0 0 15px 15px;">
				        <p style="margin-top: 1px; margin-bottom: 5px;">
				            <input type="text" id="address1" name="address1" value="${dto.addr1}" maxlength="50" 
				                       class="boxTF" style="width: 95%;" placeholder="기본 주소" readonly="readonly">
				        </p>
				        <p style="margin-bottom: 5px;">
				            <input type="text" id="address2" name="address2" value="${dto.addr2}" maxlength="50"
